...
<ul class="unfoldingList">
  ...
  <li>
    ...
    <div class="unfoldingList">
      <?php include $_SERVER['DOCUMENT_ROOT'] .'/TRACTOR/tracked_agricultural_tractors/TSH_600/specifications/tractor.html';?>
    </div>
  </li>
  ...
  <li>
    ...
    <div class="unfoldingList">
      <?php include $_SERVER['DOCUMENT_ROOT'] .'/TRACTOR/tracked_agricultural_tractors/TSH_600/specifications/engine.html';?>
    </div>
  </li>
  <div class="clearfix"></div>
  ...
  <li>
    ...
    <div class="unfoldingList">
      <?php include $_SERVER['DOCUMENT_ROOT'] .'/TRACTOR/tracked_agricultural_tractors/TSH_600/specifications/transmission.html';?>
    </div>
  </li>
  <div class="clearfix"></div>
  ...
  <li>
    ...
    <div class="unfoldingList">
      <?php include $_SERVER['DOCUMENT_ROOT'] .'/TRACTOR/tracked_agricultural_tractors/TSH_600/specifications/chassis.html';?>
    </div>
  </li>
  <div class="clearfix"></div>
  ...
  <li>
    ...
    <div class="unfoldingList">
      <?php include $_SERVER['DOCUMENT_ROOT'] .'/TRACTOR/tracked_agricultural_tractors/TSH_600/specifications/cabin.html';?>
    </div>
  </li>
  <div class="clearfix"></div>
  ...
  <li>
    ...
    <div class="unfoldingList">
      <?php include $_SERVER['DOCUMENT_ROOT'] .'/TRACTOR/tracked_agricultural_tractors/TSH_600/specifications/control.html';?>
    </div>
  </li>
  <div class="clearfix"></div>
  ...
  <li>
    ...
    <div class="unfoldingList">
      <?php include $_SERVER['DOCUMENT_ROOT'] .'/TRACTOR/tracked_agricultural_tractors/TSH_600/specifications/load_capacity.html';?>
    </div>
  </li>
  <div class="clearfix"></div>
  ...
  <li>
    ...
    <div class="unfoldingList">
      <?php include $_SERVER['DOCUMENT_ROOT'] .'/TRACTOR/tracked_agricultural_tractors/TSH_600/specifications/equipment.html';?>
    </div>
  </li>
  <div class="clearfix"></div>
